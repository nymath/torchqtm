...
def rolling_apply_scalar(values: np.ndarray, window_size: int, func: Callable[..., Scalar]):

    apply_func = generate_numba_apply_func(func, nopython=True, nogil=True, parallel=True)
    ...
    def calc(x):
        ...
        return apply_func(x, start, end, window_size)
